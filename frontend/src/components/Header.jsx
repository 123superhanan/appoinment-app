...
const Header = () => {
  return (
    <>
    <div className='flex  md:felx-row flex-wrap bg-primary rounded-lg px-6 md:px-10 lg:px-20'>
    {/* ------ left  Side ------ */}
    <div className='md:w-1/2 flex flex-col items-start justify-center gap-4 py-9 m-auto md:py-[10vw] md:mb-[-30px]'>
        ...
        <div className='flex flex-col md:flex-row items-center gap-4 text-white font-light text-sm '>
