...
const Appointment = () => {
  ...
  const { doctors, addAppointment, currencySymbol } = useContext(AppContext);
  ...
  const { user } = useAuth(); // assuming user object has _id or id
  ...
  const handleBookAppointment = async () => {
    ...
    if (!patientId) return toast.error("You must be logged in to book");
