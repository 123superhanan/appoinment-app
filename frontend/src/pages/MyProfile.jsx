...
<p className='font-medium'>Address:</p>
{
   ...
   <p>
    ...
    <br/>
    <input  className='bg-gray-50 ' value={userData.address.line2} onChange={e => setUserData (prev => ({...prev,address:{ ...prev,address,  line1:e.target.value}}))} type="text" />
   </p>
   :
...
<div>
  ...
  : 
  <p className='bg-gray-200'>{userData.gender}</p>
}

<p className='font-medium'>Birthday:</p>
{
  isedit ? <input className='bg-gray-100 max-w-28' type="text" value={userData.dob} onChange={e => setUserData (prev => ({...prev,dob:e.target.value}) ) } /> : <p className='bg-gray-200'>{userData.dob}</p>
}
  </div>
</div>
